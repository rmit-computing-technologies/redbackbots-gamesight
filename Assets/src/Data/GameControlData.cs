...
namespace Data
{
    ...
    public class GameControlData
    {
        ...
        public const byte GAMECONTROLLER_STRUCT_VERSION = 18;
        ...
        public const byte COMPETITION_TYPE_SHARED_AUTONOMY = 1;
        ...
        public const byte STATE_STANDBY = 5;
        ...
        public MemoryStream ToByteArray()
        {
            ...
            {
                writer.Write(aTeam.ToByteArray());
            }
